 ...
 * @version 1.0
 *
 * @brief x86_64 CPU abstraction functions and definitions. 
 * 
 * @details x86_64 CPU abstraction: setting functions and structures, used to set 
 * the GDT, IDT and TSS of the CPU. This file also ontains the delarations of 
 * the 256 interrupt handlers of the x86_64 interrupts.
 * 
 * @copyright Alexy Torres Aurora Dugo
 ******************************************************************************/

#ifndef __X86_64_CPU_SETTINGS_H_
#define __X86_64_CPU_SETTINGS_H_
...
#endif /* #ifndef __X86_64_CPU_SETTINGS_H_ */
