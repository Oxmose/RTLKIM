...
TEST_ARCH_DIR = Tests/Tests/x86_64
TESTS_INC  = Tests
...
ASFLAGS = -gdwarf  -f elf64 -w+gnu-elf-extensions
...
init:
	@echo "\e[1m\e[34m=== Building UTK for x86_64 architecture\e[22m\e[39m"
...
ifeq ($(TESTS), TRUE)
	...
	$(CC) $(CFLAGS) $< -o $@ -I $(INC_DIR) -I $(INC_ARCH) -I $(INC_CPU) -I $(CONFIG_DIR) -I $(TESTS_INC) $(shell if [ ! -z $(findstring $(notdir $<),$(MCLARGE_FILES)) ]; then \
		echo "-mcmodel=large"; \
	fi;)
else
	@echo  "\e[32m$< \e[22m\e[39m-> \e[1m\e[94m$@\e[22m\e[39m"
	$(CC) $(CFLAGS) $< -o $@ -I $(INC_DIR) -I $(INC_ARCH) -I $(INC_CPU) -I $(CONFIG_DIR) $(shell if [ ! -z $(findstring $(notdir $<),$(MCLARGE_FILES)) ]; then \
		echo "-mcmodel=large"; \
	fi;)
endif
