 ...
 * kernel.
 */
#define KERNEL_RESERVED_PAGING 8
...
/** @brief Use x86_64 architecture. */
#define ARCH_X86_64  1
/** @brief Use x86_64 basic BSP. */
#define BSP_X86_64 1

/** @brief UTK current architecture. */
#define UTK_ARCH ARCH_X86_64
/** @brief UTK current BSP. */
#define UTK_BSP  BSP_X86_64
