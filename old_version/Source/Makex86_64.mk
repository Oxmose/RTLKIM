...
MODULES  = IO Time Memory Drivers Core Lib User Sync Communication Interrupt \
		   Arch/x86_64/API Arch/x86_64/Boot \
	       Arch/x86_64/Cpu Arch/x86_64/Memory
...
QEMUOPTS = -cpu Nehalem -d guest_errors -rtc base=localtime -m 16G \
           -gdb tcp::1234 -smp 4 \
...
init:
	@echo "\e[1m\e[34mx86_64 architecture selected\e[22m\e[39m"
	@mkdir -p $(OBJ_DIRS)
	@mkdir -p $(BIN_DIR)
...
run:
	...
	@$(QEMU) $(QEMUOPTS) -boot d -cdrom ../Image/bootable.iso -serial stdio
...
debug:
	...
	@$(RM) -f ../Image/bootable.iso
	grub-mkrescue -o ../Image/bootable.iso ../Image
	@$(QEMU) $(QEMUOPTS) -boot d -cdrom ../Image/bootable.iso -serial stdio -S
