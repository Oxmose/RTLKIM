...
/** @brief Define the GDT pointer, contains the 
...
/** 
 * @brief Defines the gdt_ptr_t type as a shortcut for struct 
 * gdt_ptr. 
 */
typedef struct gdt_ptr gdt_ptr_t;

/** @brief Define the IDT pointer, contains the 
...
/** 
 * @brief Defines the idt_ptr_t type as a shortcut for struct 
 * idt_ptr. 
 */
