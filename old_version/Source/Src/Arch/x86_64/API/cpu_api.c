...
{
    /* Set EIP, ESP and EBP */
    thread->cpu_context.rip = (address_t)entry_point;
    thread->cpu_context.rsp = (address_t)&thread->stack[stack_index - 17];
    thread->cpu_context.rbp = (address_t)&thread->stack[stack_index - 1];
    ...
    thread->stack[stack_index - 3]  = thread->cpu_context.rip;
    ...
    thread->stack[stack_index - 17] = thread->cpu_context.rbp;
    thread->stack[stack_index - 18] = thread->cpu_context.rsp;
}
